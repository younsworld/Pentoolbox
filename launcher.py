...
# Aucune liste d'identifiants en clair ici (launcher.py est un
...
if __name__ == "__main__":
    ...
    # sous-paquet. Rappel: launcher.py reste un entrypoint obsolete ;
    # ce correctif ne fait que suivre le deplacement du fichier.
